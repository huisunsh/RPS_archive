...
% parameters setting
 for ppt = 1:consts.npair
     winner_par = sprintf('W%s.csv','WSLS');
     loser_par = sprintf('L%s.csv','WSLS');
    ...
    for CurrentTrial=1:consts.ntrials
        ...
        if CurrentTrial == 1 %first trial
            ...
            [ChoiceProbP1R,ChoiceProbP1P,ChoiceProbP1S] = CalculateWSLSChoiceProb(P1DecisionC, P1WLT, wa1, wa2, wa3);
            [ChoiceProbP2R,ChoiceProbP2P,ChoiceProbP2S] = CalculateWSLSChoiceProb(P2DecisionC, P2WLT, la1, la2, la2);
