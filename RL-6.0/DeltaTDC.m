function [ nlnL1] = DeltaTDC (theta, winnerchoice, loserchoice)
 global consts;
    ...
    for CurrentRepNum=1:consts.ntrials
        s = (CurrentRepNum/10)^c; %sensitivity
            % make choice
            if CurrentRepNum == 1 %first trial
                ...
                % Update Expectancy
                ExpecP1(P1DecisionC+1) = ExpecP1(P1DecisionC+1) + a*(P1Utility-ExpecP1(P1DecisionC+1));
