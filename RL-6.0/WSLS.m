function [ nlnL1] = WSLS (theta, winnerchoice, loserchoice)
 global consts;

 a1 = theta(1); %win stay
 a2 = theta(2); %lose shift-counterclockwise (RPS)
 a3 = theta(3); %lose shift-clockwise (RSP)
 ...
 ChoiceProbP2S = 1/3;
    ...
    for CurrentRepNum=1:consts.ntrials
            ...
            if CurrentRepNum == 1 %first trial
                ...
                [ChoiceProbP1R,ChoiceProbP1P,ChoiceProbP1S] = CalculateWSLSChoiceProb(P1DecisionC, P1WLT, a1,a2,a3);
                [ChoiceProbP2R,ChoiceProbP2P,ChoiceProbP2S] = CalculateWSLSChoiceProb(P2DecisionC, P2WLT, a1,a2,a3);
