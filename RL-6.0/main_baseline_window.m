...
for windowsize = 1:50
    for ppt = 1:consts.npair
        W = winnerchoice(ppt,:);
        nlnLW_empirical_window(windowsize, ppt,:) = baseline_empirical_window(W, windowsize, 0.05);
    end
    
    for ppt = 1:consts.npair
        L = loserchoice(ppt,:); 
        nlnLL_empirical_window(windowsize, ppt,:) = baseline_empirical_window(L, windowsize, 0.05);
